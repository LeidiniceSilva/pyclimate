...
ax.plot(1, diff_djf_rcm_pre_rcp26_samz, label='RegCM4.7 RCP2.6', mfc='blue', color='black', marker='o')
...
ax.plot(1, diff_djf_rcm_pre_rcp85_samz, label='RegCM4.7 RCP8.5', mfc='red', color='black', marker='o')
...
ax.plot(1, diff_djf_gcm_pre_rcp26_samz, label='HadGEM2-ES RCP2.6', mfc='blue', color='black', marker='s')
...
ax.plot(1, diff_djf_gcm_pre_rcp85_samz, label='HadGEM2-ES RCP8.5',mfc='red', color='black', marker='s')
