...
plt.title(u'A)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-10, 10)
...
plt.title(u'B)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-10, 10)
plt.yticks(np.arange(-10, 15, 5), fontsize=7)
plt.xticks(time, ('SAMZ', 'ENEB', 'MATOPIBA'), fontsize=7)
plt.axhline(0, linewidth=1., linestyle='--', color='black')
...
plt.title(u'C)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-10, 10)
plt.yticks(np.arange(-10, 15, 5), fontsize=7)
plt.xticks(time, ('SAMZ', 'ENEB', 'MATOPIBA'), fontsize=7)
plt.axhline(0, linewidth=1., linestyle='--', color='black')
...
plt.title(u'D)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-10, 10)
plt.yticks(np.arange(-10, 15, 5), fontsize=7)
plt.xticks(time, ('SAMZ', 'ENEB', 'MATOPIBA'), fontsize=7)
plt.axhline(0, linewidth=1., linestyle='--', color='black')
...
plt.title(u'E)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-2, 2)
...
plt.title(u'F)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-20, 20)
...
plt.title(u'G)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-100, 100)
...
plt.title(u'H)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-50, 50)
...
plt.title(u'I)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-100, 100)
plt.yticks(np.arange(-100, 150, 50), fontsize=7)
plt.xticks(time, ('SAMZ', 'ENEB', 'MATOPIBA'), fontsize=7)
plt.axhline(0, linewidth=1., linestyle='--', color='black')
...
plt.title(u'J)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-50, 50)
plt.yticks(np.arange(-50, 75, 25), fontsize=7)
plt.xticks(time, ('SAMZ', 'ENEB', 'MATOPIBA'), fontsize=7)
plt.axhline(0, linewidth=1., linestyle='--', color='black')
...
plt.title(u'K)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-100, 100)
plt.yticks(np.arange(-100, 150, 50), fontsize=7)
plt.xticks(time, ('SAMZ', 'ENEB', 'MATOPIBA'), fontsize=7)
plt.axhline(0, linewidth=1., linestyle='--', color='black')
