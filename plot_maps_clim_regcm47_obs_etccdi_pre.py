...
cbar.set_label('PRCPTOT (mm)', size=6, labelpad=10, fontweight='bold', rotation=90)
...
cbar.set_label('SDII (mm d⁻¹)', size=6, labelpad=10, fontweight='bold', rotation=90)
cbar.ax.tick_params(labelsize=6) 
...
cbar.set_label('R10mm (days)', size=6, labelpad=10, fontweight='bold', rotation=90)
cbar.ax.tick_params(labelsize=6) 
...
cbar.set_label('R20mm (days)', size=6, labelpad=10, fontweight='bold', rotation=90)
cbar.ax.tick_params(labelsize=6) 
