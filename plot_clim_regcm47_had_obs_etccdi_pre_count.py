...
plt.ylabel(u'prectot (mm)', fontsize=7, fontweight='bold')
...
plt.title(u'B) Reg y={0}x+{1}'.format(round(gcm_prcptot_median,2),round(gcm_prcptot_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(1300, 2500, 300), fontsize=7)
...
ax.tick_params(axis='x', direction='in', length=2, which='both', top=False, labelbottom=False)
ax.tick_params(axis='y', direction='in', length=2, which='both', right=False, labelleft=False)
plt.title(u'E) Reg y={0}x+{1}'.format(round(gcm_r95p_median,2),round(gcm_r95p_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(20, 40, 5), fontsize=7)
...
plt.ylabel(u'r99p \n(mm)', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(6, 14, 2), fontsize=7)
...
ax.tick_params(axis='x', direction='in', length=2, which='both', top=False, labelbottom=False)
ax.tick_params(axis='y', direction='in', length=2, which='both', right=False, labelleft=False)
plt.title(u'H) Reg y={0}x+{1}'.format(round(gcm_r99p_median,2),round(gcm_r99p_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(6, 14, 2), fontsize=7)
...
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(14, 30, 4), fontsize=7)

ax = fig.add_subplot(6, 3, 11)
ax.plot(time, gcm_rx1day, linewidth=1., color='black', marker='.', markerfacecolor='white', markersize=5)
...
ax.tick_params(axis='x', direction='in', length=2, which='both', top=False, labelbottom=False)
ax.tick_params(axis='y', direction='in', length=2, which='both', right=False, labelleft=False)
plt.title('K) Reg y={0}x+{1}'.format(round(gcm_rx1day_median,2),round(gcm_rx1day_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(14, 30, 4), fontsize=7)
...
plt.ylabel(u'rx5day \n(mm d⁻¹)', fontsize=7, fontweight='bold')
plt.yticks(np.arange(40, 60, 5), fontsize=7)
...
ax.tick_params(axis='x', direction='in', length=2, which='both', top=False, labelbottom=False)
ax.tick_params(axis='y', direction='in', length=2, which='both', right=False, labelleft=False)
plt.title(u'N) Reg y={0}x+{1}'.format(round(gcm_rx5day_median,2),round(gcm_rx5day_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(40, 60, 5), fontsize=7)
...
ax.tick_params(axis='y', direction='in', length=2)
plt.title(u'P) sdii y={0}x+{1}'.format(round(obs_sdii_median,2),round(obs_sdii_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xlabel(u'Years', fontsize=7, fontweight='bold')
plt.ylabel(u'sdii \n(mm d⁻¹)', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(6, 11, 1), fontsize=7)
...
ax.spines['top'].set_visible(False)
ax.tick_params(axis='y', direction='in', length=2, which='both', right=False, labelleft=False)
plt.title(u'Q) Reg y={0}x+{1}'.format(round(gcm_sdii_median,2),round(gcm_sdii_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xlabel(u'Years', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(6, 11, 1), fontsize=7)
