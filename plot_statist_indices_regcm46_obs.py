...
plt.plot(rmse_djf_exp1_namz, corr_djf_exp1_namz,  marker='o', markersize=10, markeredgecolor='black', color='red')
plt.plot(rmse_djf_exp2_namz, corr_djf_exp2_namz,  marker='o', markersize=10, markeredgecolor='black', color='blue')
plt.plot(rmse_jja_exp1_namz, corr_jja_exp1_namz,  marker='s', markersize=10, markeredgecolor='black', color='red')
plt.plot(rmse_jja_exp2_namz, corr_jja_exp2_namz,  marker='s', markersize=10, markeredgecolor='black', color='blue')
plt.plot(rmse_ann_exp1_namz, corr_ann_exp1_namz,  marker='^', markersize=10, markeredgecolor='black', color='red')
plt.plot(rmse_ann_exp2_namz, corr_ann_exp2_namz,  marker='^', markersize=10, markeredgecolor='black', color='blue')
...
plt.axvspan(0, 3, ymin = 0.50, ymax = 1, color='gray', alpha=0.4)
plt.axvspan(3, 6, ymin = 0.0, ymax = 0.50, color='gray', alpha=0.4)
plt.plot(rmse_djf_exp1_samz, corr_djf_exp1_samz,  marker='o', markersize=10, markeredgecolor='black', color='red')
plt.plot(rmse_djf_exp2_samz, corr_djf_exp2_samz,  marker='o', markersize=10, markeredgecolor='black', color='blue')
plt.plot(rmse_jja_exp1_samz, corr_jja_exp1_samz,  marker='s', markersize=10, markeredgecolor='black', color='red')
plt.plot(rmse_jja_exp2_samz, corr_jja_exp2_samz,  marker='s', markersize=10, markeredgecolor='black', color='blue')
plt.plot(rmse_ann_exp1_samz, corr_ann_exp1_samz,  marker='^', markersize=10, markeredgecolor='black', color='red')
plt.plot(rmse_ann_exp2_samz, corr_ann_exp2_samz,  marker='^', markersize=10, markeredgecolor='black', color='blue')
...
plt.axvspan(0, 3, ymin = 0.50, ymax = 1, color='gray', alpha=0.4)
plt.axvspan(3, 6, ymin = 0.0, ymax = 0.50, color='gray', alpha=0.4)
plt.plot(rmse_djf_exp1_neb, corr_djf_exp1_neb,  marker='o', markersize=10, markeredgecolor='black', color='red')
plt.plot(rmse_djf_exp2_neb, corr_djf_exp2_neb,  marker='o', markersize=10, markeredgecolor='black', color='blue')
plt.plot(rmse_jja_exp1_neb, corr_jja_exp1_neb,  marker='s', markersize=10, markeredgecolor='black', color='red')
plt.plot(rmse_jja_exp2_neb, corr_jja_exp2_neb,  marker='s', markersize=10, markeredgecolor='black', color='blue')
plt.plot(rmse_ann_exp1_neb, corr_ann_exp1_neb,  marker='^', markersize=10, markeredgecolor='black', color='red')
plt.plot(rmse_ann_exp2_neb, corr_ann_exp2_neb,  marker='^', markersize=10, markeredgecolor='black', color='blue')
