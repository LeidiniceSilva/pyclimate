...
map, xx, yy = basemap(lat, lon)
plt.title(u'M) DTR Obs (°C)', loc='left', fontsize=6, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'N) DTR Reg (°C)', loc='left', fontsize=6, fontweight='bold')
plt.xlabel(u'Longitude', fontsize=6, fontweight='bold', labelpad=10)
plt.text(-51, -5, u'\u25B2 \nN ', fontsize=6)
...
map, xx, yy = basemap(lat, lon)
plt.title(u'O) DTR Had (°C)', loc='left', fontsize=6, fontweight='bold')
plt.xlabel(u'Longitude', fontsize=6, fontweight='bold', labelpad=10)
plt.text(-51, -5, u'\u25B2 \nN ', fontsize=6)
