...
plt.setp(l1, linewidth=1, color='blue', marker='.', linestyle='dashed')
plt.setp(l2, linewidth=1, color='red', marker='.', linestyle='dashed')
plt.setp(l3, linewidth=1, color='blue', marker='s', linestyle='dashed')
plt.setp(l4, linewidth=1, color='red', marker='s', linestyle='dashed')
...
plt.legend(annual_cycle5, legend, loc='lower center', bbox_to_anchor=(1.1, -0.8), shadow=True, ncol=4, fontsize=8)
