...
pre_annual_gcm_rcp85_hist = pre_annual_gcm_rcp85 - pre_son_gcm_hist
...
map, xx, yy = basemap(lat, lon)
plot_maps_diff = map.contourf(xx, yy, pre_annual_rcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
...
map, xx, yy = basemap(lat, lon)
plot_maps_diff = map.contourf(xx, yy, pre_annual_gcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
cbar = map.colorbar(ticks=levs1, drawedges=True, ax=ax)
cbar.ax.tick_params(labelsize=6) 
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
map, xx, yy = basemap(lat, lon)
plot_maps_diff = map.contourf(xx, yy, pre_annual_rcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
cbar = map.colorbar(ticks=levs1, drawedges=True, ax=ax)
cbar.ax.tick_params(labelsize=6) 
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
plt.xlabel(u'Longitude', fontsize=6, labelpad=10, fontweight='bold')
map, xx, yy = basemap(lat, lon)
plot_maps_diff = map.contourf(xx, yy, pre_annual_gcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG, extend='both')
cbar = map.colorbar()
cbar.ax.tick_params(labelsize=6)     
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.ylabel(u'Latitude', fontsize=6, labelpad=15, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_djf_rcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[1,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'B)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_mam_rcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'C)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_jja_rcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'D)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_son_rcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'E)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_annual_rcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ cbar = map.colorbar(ticks=levs1, drawedges=True, ax=ax)
#~ cbar.ax.tick_params(labelsize=6) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.ylabel(u'Latitude', fontsize=6, labelpad=15, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_djf_gcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[1,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'G)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_mam_gcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'H)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_jja_gcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'I)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_son_gcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'J)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_annual_gcm_rcp26_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ cbar = map.colorbar(ticks=levs1, drawedges=True, ax=ax)
#~ cbar.ax.tick_params(labelsize=6) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.ylabel(u'Latitude', fontsize=6, labelpad=15, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_djf_rcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[1,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'L)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_mam_rcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'M)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_jja_rcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.title(u'N)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_son_rcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
...
#~ plt.title(u'O)', loc='left', fontsize=8, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_annual_rcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ cbar = map.colorbar(ticks=levs1, drawedges=True, ax=ax)
#~ cbar.ax.tick_params(labelsize=6) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.xlabel(u'Longitude', fontsize=6, labelpad=10, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_djf_gcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[1,0,0,0], linewidth=0.4, color='black')

#~ ax = fig.add_subplot(4, 5, 17)
#~ plt.title(u'Q)', fontsize=6, fontweight='bold')
#~ plt.xlabel(u'Longitude', fontsize=8, labelpad=10, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_mam_gcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.xlabel(u'Longitude', fontsize=6, labelpad=10, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_jja_gcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.xlabel(u'Longitude', fontsize=6, labelpad=10, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_son_gcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
...
#~ plt.xlabel(u'Longitude', fontsize=6, labelpad=10, fontweight='bold')
#~ map, xx, yy = basemap(lat, lon)
#~ plot_maps_diff = map.contourf(xx, yy, tas_annual_gcm_rcp85_hist, levels=levs1, latlon=True, cmap=cm.BrBG)
#~ cbar = map.colorbar(ticks=levs1, drawedges=True, ax=ax)
#~ cbar.ax.tick_params(labelsize=6) 
#~ map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
#~ map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
