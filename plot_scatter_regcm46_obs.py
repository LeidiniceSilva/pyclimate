...
plt.plot(time, namz_exp1_djf, color='blue', marker='.', markerfacecolor='white', label='Reg_H')
plt.plot(time, namz_exp2_djf, color='red', marker='.', markerfacecolor='white', label='Reg_UW')
...
plt.legend(fontsize=8, loc=9, ncol=3, shadow=True)

ax2 = plt.subplot(gs[1])
plt.plot([0,14],[0,14], color='black', linewidth=1., linestyle='--')
plt.scatter(namz_obs_djf, namz_exp1_djf, edgecolors='blue', s=40, color='white', marker='.', label='Reg_H')
plt.scatter(namz_obs_djf, namz_exp2_djf, edgecolors='red', s=40, color='white', marker='.', label='Reg_UW')
...
plt.plot(time, samz_exp1_djf, color='blue', marker='.', markerfacecolor='white', label='Reg_H')
plt.plot(time, samz_exp2_djf, color='red', marker='.', markerfacecolor='white', label='Reg_UW')
...
plt.plot([0,14],[0,14], color='black', linewidth=1., linestyle='--')
plt.scatter(samz_obs_djf, samz_exp1_djf, edgecolors='blue', s=40, color='white', marker='.', label='Reg_H')
plt.scatter(samz_obs_djf, samz_exp2_djf, edgecolors='red', s=40, color='white', marker='.', label='Reg_UW')
...
plt.plot(time, neb_exp1_djf, color='blue', marker='.', markerfacecolor='white', label='Reg_H')
plt.plot(time, neb_exp2_djf, color='red', marker='.', markerfacecolor='white', label='Reg_UW')
...
plt.plot([0,14],[0,14], color='black', linewidth=1., linestyle='--')
plt.scatter(neb_obs_djf, neb_exp1_djf, edgecolors='blue', s=40, color='white', marker='.', label='Reg_H')
plt.scatter(neb_obs_djf, neb_exp2_djf, edgecolors='red', s=40, color='white', marker='.', label='Reg_UW')
