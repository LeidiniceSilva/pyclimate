...
plt.setp(l3, linewidth=1, color='red', marker='^')
plt.setp(l4, linewidth=1, color='green', marker='+')
plt.setp(l5, linewidth=1, color='yellow', marker='*')
plt.setp(l6, linewidth=1, color='magenta', marker='x')

ax2 = fig.add_subplot(3, 2, 2)
annual_cycle2 = ax2.plot(time, np.nanmean(t_reg_samz, axis=1), time, t_had_samz, time, t_cru_samz, time, t_udel_samz, time, t_era5_samz)
...
plt.setp(l3, linewidth=1, color='red', marker='^')
plt.setp(l4, linewidth=1, color='green', marker='+')
plt.setp(l5, linewidth=1, color='magenta', marker='x')
...
annual_cycle4 = ax4.plot(time, np.nanmean(t_reg_eneb, axis=1), time, t_had_eneb, time, t_cru_eneb, time, t_udel_eneb, time, t_era5_eneb)
...
annual_cycle6 = ax6.plot(time, np.nanmean(t_reg_matopiba, axis=1), time, t_had_matopiba, time, t_cru_matopiba, time, t_udel_matopiba, time, t_era5_matopiba)
