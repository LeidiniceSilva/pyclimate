...
rcm_txx, rcm_txx_trend, rcm_txx_median = import_function_trend(np.nanmean(rcm_txx, axis=1))
rcm_txn, rcm_txn_trend, rcm_txn_median = import_function_trend(np.nanmean(rcm_txn, axis=1))
rcm_tnx, rcm_tnx_trend, rcm_tnx_median = import_function_trend(np.nanmean(rcm_tnx, axis=1))
rcm_tnn, rcm_tnn_trend, rcm_tnn_median = import_function_trend(np.nanmean(rcm_tnn, axis=1))
rcm_dtr, rcm_dtr_trend, rcm_dtr_median = import_function_trend(np.nanmean(rcm_dtr, axis=1))
...
plt.yticks(np.arange(32, 42, 2), fontsize=7)

ax = fig.add_subplot(5, 3, 2)
ax.plot(time, rcm_txx, linestyle='', linewidth=1., color='black', marker='.', markerfacecolor='white', markersize=5)
ax.plot(time, rcm_txx_trend, linewidth=1., color='gray')
ax.axhline(rcm_txx_median, linewidth=1., linestyle='dashed', color='black', alpha=2)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
...
plt.title(u'B) Reg y={0}x+{1}'.format(round(rcm_txx_median,2),round(rcm_txx_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(32, 42, 2), fontsize=7)
...
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(17, 29, 2), fontsize=7)

ax = fig.add_subplot(5, 3, 5)
ax.plot(time, rcm_txn, linestyle='', linewidth=1., color='black', marker='.', markerfacecolor='white', markersize=5)
ax.plot(time, rcm_txn_trend, linewidth=1., color='gray')
ax.axhline(rcm_txn_median, linewidth=1., linestyle='dashed', color='black', alpha=2)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
ax.tick_params(axis='x', direction='in', length=2, which='both', top=False, labelbottom=False)
ax.tick_params(axis='y', direction='in', length=2, which='both', right=False, labelleft=False)
plt.title(u'E) Reg y={0}x+{1}'.format(round(rcm_txn_median,2),round(rcm_txn_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(17, 29, 2), fontsize=7)
...
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(22, 30, 2), fontsize=7)

ax = fig.add_subplot(5, 3, 8)
ax.plot(time, rcm_tnx, linestyle='', linewidth=1., color='black', marker='.', markerfacecolor='white', markersize=5)
ax.plot(time, rcm_tnx_trend, linewidth=1., color='gray')
ax.axhline(rcm_tnx_median, linewidth=1., linestyle='dashed', color='black', alpha=2)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
ax.tick_params(axis='x', direction='in', length=2, which='both', top=False, labelbottom=False)
ax.tick_params(axis='y', direction='in', length=2, which='both', right=False, labelleft=False)
plt.title(u'H) Reg y={0}x+{1}'.format(round(rcm_tnx_median,2),round(rcm_tnx_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(22, 30, 2), fontsize=7)
...
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(12, 22, 2), fontsize=7)

ax = fig.add_subplot(5, 3, 11)
ax.plot(time, rcm_tnn, linestyle='', linewidth=1., color='black', marker='.', markerfacecolor='white', markersize=5)
ax.plot(time, rcm_tnn_trend, linewidth=1., color='gray')
ax.axhline(rcm_tnn_median, linewidth=1., linestyle='dashed', color='black', alpha=2)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
ax.tick_params(axis='x', direction='in', length=2, which='both', top=False, labelbottom=False)
ax.tick_params(axis='y', direction='in', length=2, which='both', right=False, labelleft=False)
plt.title('K) Reg y={0}x+{1}'.format(round(rcm_tnn_median,2),round(rcm_tnn_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(12, 22, 2), fontsize=7)
...
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(6, 13, 2), fontsize=7)

ax = fig.add_subplot(5, 3, 14)
ax.plot(time, rcm_dtr, linestyle='', linewidth=1., color='black', marker='.', markerfacecolor='white', markersize=5)
ax.plot(time, rcm_dtr_trend, linewidth=1., color='gray')
ax.axhline(rcm_dtr_median, linewidth=1., linestyle='dashed', color='black', alpha=2)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
ax.tick_params(axis='x', direction='in', length=2)
ax.tick_params(axis='y', direction='in', length=2, which='both', right=False, labelleft=False)
plt.title(u'N) Reg y={0}x+{1}'.format(round(rcm_dtr_median,2),round(rcm_dtr_trend[1],2)), loc='left', fontsize=7, fontweight='bold')
plt.xlabel(u'Years', fontsize=7, fontweight='bold')
plt.xticks(np.arange(1, 20, 4), objects, fontsize=7)
plt.yticks(np.arange(6, 13, 2), fontsize=7)
