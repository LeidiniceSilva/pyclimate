...
plt.text(0.5, 2.5, 'R²=0.71 (CRU)', fontsize=6, color='green', fontweight='bold')
plt.text(0.5, 1.5, 'R²=0.67 (GPCP)', fontsize=6, color='green', fontweight='bold')
plt.text(0.5, 0.5, 'R²=0.66 (ERA5)', fontsize=6, color='green', fontweight='bold')
plt.text(8, 2.5, 'R²=0.95 (CRU)', fontsize=6, color='red', fontweight='bold')
plt.text(8, 1.5, 'R²=0.93 (GPCP)', fontsize=6, color='red', fontweight='bold')
plt.text(8, 0.5, 'R²=0.93 (ERA5)', fontsize=6, color='red', fontweight='bold')
...
ax.spines['top'].set_visible(False)
plt.setp(ax.get_xticklabels(), visible=False)
plt.text(0.5, 22, 'R²=0.73 (CRU)', fontsize=6, color='green', fontweight='bold')
plt.text(0.5, 21, 'R²=0.57 (ERA5)', fontsize=6, color='green', fontweight='bold')
plt.text(8, 22, 'R²=0.79 (CRU)', fontsize=6, color='red', fontweight='bold')
plt.text(8, 21, 'R²=0.46 (ERA5)', fontsize=6, color='red', fontweight='bold')
plt.legend(fontsize=6, loc=1, ncol=2)
...
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plt.text(0.5, 10, 'R²=0.91 (CRU)', fontsize=6, color='green', fontweight='bold')
plt.text(0.5, 9, 'R²=0.93(GPCP)', fontsize=6, color='green', fontweight='bold')
plt.text(0.5, 8, 'R²=0.93 (ERA5)', fontsize=6, color='green', fontweight='bold')
plt.text(8, 10, 'R²=0.88 (CRU)', fontsize=6, color='red', fontweight='bold')
plt.text(8, 9, 'R²=0.91 (GPCP)', fontsize=6, color='red', fontweight='bold')
plt.text(8, 8, 'R²=0.91 (ERA5)', fontsize=6, color='red', fontweight='bold')
...
ax.spines['left'].set_visible(False)
ax.spines['top'].set_visible(False)
plt.text(0.5, 30, 'R²=0.66 (CRU)', fontsize=6, color='green', fontweight='bold')
plt.text(0.5, 29, 'R²=0.75 (ERA5)', fontsize=6, color='green', fontweight='bold')
plt.text(8, 30, 'R²=0.92 (CRU)', fontsize=6, color='red', fontweight='bold')
plt.text(8, 29, 'R²=0.94 (ERA5)', fontsize=6, color='red', fontweight='bold')
