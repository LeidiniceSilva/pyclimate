...
plt.title(u'G) CDD (days)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-200, 200)
...
plt.title(u'H) CWD (days)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-50, 50)
...
plt.title(u'I) R10mm (days)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-50, 50)
plt.yticks(np.arange(-50, 75, 25), fontsize=7)
plt.xticks(time, ('SAMZ', 'ENEB', 'MATOPIBA'), fontsize=7)
plt.axhline(0, linewidth=1., linestyle='--', color='black')
...
plt.title(u'J) R20mm (days)', loc='left', fontweight='bold', fontsize=7)
plt.ylim(-10, 10)
plt.yticks(np.arange(-10, 15, 5), fontsize=7)
plt.xticks(time, ('SAMZ', 'ENEB', 'MATOPIBA'), fontsize=7)
plt.axhline(0, linewidth=1., linestyle='--', color='black')
