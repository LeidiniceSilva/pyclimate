...
(periodo de 1980/01/01  a 1989/12/31)
"""

# pegando variavel
path_var = '/home/nice/Downloads/'
ETo = xr.open_mfdataset(path_var + 'ETo_daily_UT_Brazil_v2_19800101_19891231.nc')
prec = xr.open_mfdataset(path_var + 'prec_daily_UT_Brazil_v2.1_19800101_19891231.nc')
...
fig.suptitle(u'Diferença sazonal entre precipitação e ETo', fontsize=16, y=.98)
plt.show()
exit()
