...
av_pre_annual = compute_added_value(pre_annual_gcm, pre_annual_rcm, pre_annual_cru)
...
av_tas_annual = compute_added_value(tas_annual_gcm, np.nanmean(tas_annual_rcm, axis=0), tas_annual_cru)
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_pre_annual_rcm_cru = ma.masked_where(p_value_pre_annual_rcm_cru >= 0.05, p_value_pre_annual_rcm_cru) 
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_pre_annual_gcm_cru = ma.masked_where(p_value_pre_annual_gcm_cru >= 0.05, p_value_pre_annual_gcm_cru) 
#~ map.contourf(xx, yy, p_value_pre_annual_gcm_cru, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[1,0,0,0], linewidth=0.4, color='black')
#~ p_value_pre_djf_rcm_gcm = ma.masked_where(p_value_pre_djf_rcm_gcm >= 0.05, p_value_pre_djf_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_pre_djf_rcm_gcm, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_pre_mam_rcm_gcm = ma.masked_where(p_value_pre_mam_rcm_gcm >= 0.05, p_value_pre_mam_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_pre_mam_rcm_gcm, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_pre_jja_rcm_gcm = ma.masked_where(p_value_pre_jja_rcm_gcm >= 0.05, p_value_pre_jja_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_pre_jja_rcm_gcm, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_pre_son_rcm_gcm = ma.masked_where(p_value_pre_son_rcm_gcm >= 0.05, p_value_pre_son_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_pre_son_rcm_gcm, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_pre_annual_rcm_gcm = ma.masked_where(p_value_pre_annual_rcm_gcm >= 0.05, p_value_pre_annual_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_pre_annual_rcm_gcm, colors='none', hatches=['....'])
...
#~ map.contourf(xx, yy, p_value_tas_djf_rcm_cru, colors='none', hatches=['....'])
...
#~ map.contourf(xx, yy, p_value_tas_mam_rcm_cru, colors='none', hatches=['....'])
...
#~ map.contourf(xx, yy, p_value_tas_jja_rcm_cru, colors='none', hatches=['....'])
...
#~ map.contourf(xx, yy, p_value_tas_son_rcm_cru, colors='none', hatches=['....'])

ax = fig.add_subplot(6, 5, 20)
plt.title(u'T)', loc='left', fontsize=8, fontweight='bold')
map, xx, yy = basemap(lat, lon)
plt_maps_bias = map.contourf(xx, yy, tas_annual_rcm_bias, levels=levs1, latlon=True, cmap=cm.bwr) 
cbar = map.colorbar(ticks=levs1, drawedges=True, ax=ax)
cbar.ax.tick_params(labelsize=6) 
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_tas_annual_rcm_cru = ma.masked_where(p_value_tas_annual_rcm_cru >= 0.05, p_value_tas_annual_rcm_cru) 
#~ map.contourf(xx, yy, p_value_tas_annual_rcm_cru, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_tas_annual_gcm_cru = ma.masked_where(p_value_tas_annual_gcm_cru >= 0.05, p_value_tas_annual_gcm_cru) 
...
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[1,0,0,0], linewidth=0.4, color='black')
#~ p_value_tas_djf_rcm_gcm = ma.masked_where(p_value_tas_djf_rcm_gcm >= 0.05, p_value_tas_djf_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_tas_djf_rcm_gcm, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_tas_mam_rcm_gcm = ma.masked_where(p_value_tas_mam_rcm_gcm >= 0.05, p_value_tas_mam_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_tas_mam_rcm_gcm, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_tas_jja_rcm_gcm = ma.masked_where(p_value_tas_jja_rcm_gcm >= 0.05, p_value_tas_jja_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_tas_jja_rcm_gcm, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_tas_son_rcm_gcm = ma.masked_where(p_value_tas_son_rcm_gcm >= 0.05, p_value_tas_son_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_tas_son_rcm_gcm, colors='none', hatches=['....'])
...
map.drawmeridians(np.arange(-85.,-5.,20.), size=6, labels=[0,0,0,1], linewidth=0.4, color='black')
map.drawparallels(np.arange(-20.,15.,10.), size=6, labels=[0,0,0,0], linewidth=0.4, color='black')
#~ p_value_tas_annual_rcm_gcm = ma.masked_where(p_value_tas_annual_rcm_gcm >= 0.05, p_value_tas_annual_rcm_gcm) 
#~ map.contourf(xx, yy, p_value_tas_annual_rcm_gcm, colors='none', hatches=['....'])
