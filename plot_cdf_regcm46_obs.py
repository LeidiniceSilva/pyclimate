...
plt.plot(sortedtime_djf_exp1_namz, cdf_djf_exp1_namz, color='blue', label='Reg_H', linestyle='-.', linewidth=1.5)
plt.plot(sortedtime_djf_exp2_namz, cdf_djf_exp2_namz,  color='red', label='Reg_UW', linestyle='-.', linewidth=1.5)
...
plt.xlim(-8, 4)
plt.ylim(0, 1)
plt.xticks(np.arange(-8, 6, 2), fontsize=8)
...
plt.axvspan(-8, 0, color='red', alpha=0.2)
plt.axvspan(0, 4, color='blue', alpha=0.2)
plt.plot(sortedtime_jja_exp1_namz, cdf_jja_exp1_namz, label='Reg_H', color='blue', linestyle='-.', linewidth=1.5)
plt.plot(sortedtime_jja_exp2_namz, cdf_jja_exp2_namz, label='Reg_UW', color='red', linestyle='-.', linewidth=1.5)
...
plt.axvspan(-8, 0, color='red', alpha=0.2)
plt.axvspan(0, 4, color='blue', alpha=0.2)
plt.plot(sortedtime_ann_exp1_namz, cdf_ann_exp1_namz, label='Reg_H', color='blue', linestyle='-.', linewidth=1.5)
plt.plot(sortedtime_ann_exp2_namz, cdf_ann_exp2_namz, label='Reg_UW', color='red', linestyle='-.', linewidth=1.5)
...
plt.axvspan(-8, 0, color='red', alpha=0.2)
plt.axvspan(0, 4, color='blue', alpha=0.2)
plt.plot(sortedtime_djf_exp1_samz, cdf_djf_exp1_samz, color='blue', label='Reg_H', linestyle='-.', linewidth=1.5)
plt.plot(sortedtime_djf_exp2_samz, cdf_djf_exp2_samz,  color='red', label='Reg_UW', linestyle='-.', linewidth=1.5)
...
plt.axvspan(-8, 0, color='red', alpha=0.2)
plt.axvspan(0, 4, color='blue', alpha=0.2)
plt.plot(sortedtime_jja_exp1_samz, cdf_jja_exp1_samz, label='Reg_H', color='blue', linestyle='-.', linewidth=1.5)
plt.plot(sortedtime_jja_exp2_samz, cdf_jja_exp2_samz, label='Reg_UW', color='red', linestyle='-.', linewidth=1.5)
...
plt.axvspan(-8, 0, color='red', alpha=0.2)
plt.axvspan(0, 4, color='blue', alpha=0.2)
plt.plot(sortedtime_ann_exp1_samz, cdf_ann_exp1_samz, label='Reg_H', color='blue', linestyle='-.', linewidth=1.5)
plt.plot(sortedtime_ann_exp2_samz, cdf_ann_exp2_samz, label='Reg_UW', color='red', linestyle='-.', linewidth=1.5)
...
plt.axvspan(-8, 0, color='red', alpha=0.2)
plt.axvspan(0, 4, color='blue', alpha=0.2)
plt.plot(sortedtime_djf_exp1_neb, cdf_djf_exp1_neb, color='blue', label='Reg_H', linestyle='-.', linewidth=1.5)
plt.plot(sortedtime_djf_exp2_neb, cdf_djf_exp2_neb,  color='red', label='Reg_UW', linestyle='-.', linewidth=1.5)
...
plt.axvspan(-8, 0, color='red', alpha=0.2)
plt.axvspan(0, 4, color='blue', alpha=0.2)
plt.plot(sortedtime_jja_exp1_neb, cdf_jja_exp1_neb, label='Reg_H', color='blue', linestyle='-.', linewidth=1.5)
plt.plot(sortedtime_jja_exp2_neb, cdf_jja_exp2_neb, label='Reg_UW', color='red', linestyle='-.', linewidth=1.5)
...
plt.axvspan(-8, 0, color='red', alpha=0.2)
plt.axvspan(0, 4, color='blue', alpha=0.2)
plt.plot(sortedtime_ann_exp1_neb, cdf_ann_exp1_neb, label='Reg_H', color='blue', linestyle='-.', linewidth=1.5)
plt.plot(sortedtime_ann_exp2_neb, cdf_ann_exp2_neb, label='Reg_UW', color='red', linestyle='-.', linewidth=1.5)
