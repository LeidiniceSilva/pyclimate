...
ax1_1.set_ylabel(u'PDF', fontsize=6)
ax1_1.set_xlim(0, 15)
ax1_1.set_ylim(0, 0.4)
ax1_1.set_xticks(np.arange(0, 18, 3))
ax1_1.set_yticks(np.arange(0, 0.6, 0.2))
ax1_1.xaxis.set_tick_params(labelsize=6)
ax1_1.yaxis.set_tick_params(labelsize=6)
...
ax2_1.set_ylabel(u'PDF', fontsize=6)
ax2_1.set_xlim(22, 30)
ax2_1.set_ylim(0, 0.8)
ax2_1.set_xticks(np.arange(22, 32, 2))
ax2_1.set_yticks(np.arange(0, 1.2, 0.4))
ax2_1.xaxis.set_tick_params(labelsize=6)
ax2_1.yaxis.set_tick_params(labelsize=6)
...
ax3_1.xaxis.set_tick_params(labelsize=6)
ax3_1.yaxis.set_tick_params(labelsize=6)
...
ax4_1.xaxis.set_tick_params(labelsize=6)
ax4_1.yaxis.set_tick_params(labelsize=6)
...
ax5_1.xaxis.set_tick_params(labelsize=6)
ax5_1.yaxis.set_tick_params(labelsize=6)
...
ax6_1.xaxis.set_tick_params(labelsize=6)
ax6_1.yaxis.set_tick_params(labelsize=6)
