...
map, xx, yy = basemap(lat, lon)
plt.title(u'C) AV TXx', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'F) AV TXn', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'I) AV TNx', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'L) AV TNn', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'O) AV DTR', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'R) AV SU', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'U) AV TR', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'X) AV TX10p', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'A.1) AV TX90p', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'D.1) AV TN10p', loc='left', fontsize=8, fontweight='bold')
...
map, xx, yy = basemap(lat, lon)
plt.title(u'E.1) MBE RegCM 4.7', loc='left', fontsize=8, fontweight='bold')
plt.ylabel(u'Latitude', fontsize=6, fontweight='bold', labelpad=15)
...
map, xx, yy = basemap(lat, lon)
plt.title(u'F.1) MBE HadGEM2-ES', loc='left', fontsize=8, fontweight='bold')
plt.xlabel(u'Longitude', fontsize=6, fontweight='bold', labelpad=10)
...
map, xx, yy = basemap(lat, lon)
plt.title(u'G.1) AV TN90p', loc='left', fontsize=8, fontweight='bold')
plt.xlabel(u'Longitude', fontsize=6, fontweight='bold', labelpad=10)
...
plt.subplots_adjust(left=0.10, bottom=0.10, right=0.90, top=0.90, wspace=0.30, hspace=0.50)
