...
def import_rcm(var, area, exp, dt):
	...
	return djf_rcm, mam_rcm, jja_rcm, son_rcm
...
def import_gcm(var, area, exp, dt):
	...
	return djf_gcm, mam_gcm, jja_gcm, son_gcm
...
# Import models 
# Precipitation 
djf_rcm_pre_hist_samz, mam_rcm_pre_hist_samz, jja_rcm_pre_hist_samz, son_rcm_pre_hist_samz = import_rcm('pr', 'samz', 'hist', '1986-2005')
djf_gcm_pre_hist_samz, mam_gcm_pre_hist_samz, jja_gcm_pre_hist_samz, son_gcm_pre_hist_samz = import_gcm('pr', 'samz', 'hist', '1986-2005')
djf_rcm_pre_rcp26_samz, mam_rcm_pre_rcp26_samz, jja_rcm_pre_rcp26_samz, son_rcm_pre_rcp26_samz = import_rcm('pr', 'samz', 'rcp26', '2080-2099')
djf_gcm_pre_rcp26_samz, mam_gcm_pre_rcp26_samz, jja_gcm_pre_rcp26_samz, son_gcm_pre_rcp26_samz = import_gcm('pr', 'samz', 'rcp26', '2080-2099')
djf_rcm_pre_rcp85_samz, mam_rcm_pre_rcp85_samz, jja_rcm_pre_rcp85_samz, son_rcm_pre_rcp85_samz = import_rcm('pr', 'samz', 'rcp85', '2080-2099')
djf_gcm_pre_rcp85_samz, mam_gcm_pre_rcp85_samz, jja_gcm_pre_rcp85_samz, son_gcm_pre_rcp85_samz = import_gcm('pr', 'samz', 'rcp85', '2080-2099')

djf_rcm_pre_hist_eneb, mam_rcm_pre_hist_eneb, jja_rcm_pre_hist_eneb, son_rcm_pre_hist_eneb = import_rcm('pr', 'eneb', 'hist', '1986-2005')
djf_gcm_pre_hist_eneb, mam_gcm_pre_hist_eneb, jja_gcm_pre_hist_eneb, son_gcm_pre_hist_eneb = import_gcm('pr', 'eneb', 'hist', '1986-2005')
djf_rcm_pre_rcp26_eneb, mam_rcm_pre_rcp26_eneb, jja_rcm_pre_rcp26_eneb, son_rcm_pre_rcp26_eneb = import_rcm('pr', 'eneb', 'rcp26', '2080-2099')
djf_gcm_pre_rcp26_eneb, mam_gcm_pre_rcp26_eneb, jja_gcm_pre_rcp26_eneb, son_gcm_pre_rcp26_eneb = import_gcm('pr', 'eneb', 'rcp26', '2080-2099')
djf_rcm_pre_rcp85_eneb, mam_rcm_pre_rcp85_eneb, jja_rcm_pre_rcp85_eneb, son_rcm_pre_rcp85_eneb = import_rcm('pr', 'eneb', 'rcp85', '2080-2099')
djf_gcm_pre_rcp85_eneb, mam_gcm_pre_rcp85_eneb, jja_gcm_pre_rcp85_eneb, son_gcm_pre_rcp85_eneb = import_gcm('pr', 'eneb', 'rcp85', '2080-2099')

djf_rcm_pre_hist_matopiba, mam_rcm_pre_hist_matopiba, jja_rcm_pre_hist_matopiba, son_rcm_pre_hist_matopiba = import_rcm('pr', 'matopiba', 'hist', '1986-2005')
djf_gcm_pre_hist_matopiba, mam_gcm_pre_hist_matopiba, jja_gcm_pre_hist_matopiba, son_gcm_pre_hist_matopiba = import_gcm('pr', 'matopiba', 'hist', '1986-2005')
djf_rcm_pre_rcp26_matopiba, mam_rcm_pre_rcp26_matopiba, jja_rcm_pre_rcp26_matopiba, son_rcm_pre_rcp26_matopiba = import_rcm('pr', 'matopiba', 'rcp26', '2080-2099')
djf_gcm_pre_rcp26_matopiba, mam_gcm_pre_rcp26_matopiba, jja_gcm_pre_rcp26_matopiba, son_gcm_pre_rcp26_matopiba = import_gcm('pr', 'matopiba', 'rcp26', '2080-2099')
djf_rcm_pre_rcp85_matopiba, mam_rcm_pre_rcp85_matopiba, jja_rcm_pre_rcp85_matopiba, son_rcm_pre_rcp85_matopiba = import_rcm('pr', 'matopiba', 'rcp85', '2080-2099')
djf_gcm_pre_rcp85_matopiba, mam_gcm_pre_rcp85_matopiba, jja_gcm_pre_rcp85_matopiba, son_gcm_pre_rcp85_matopiba = import_gcm('pr', 'matopiba', 'rcp85', '2080-2099')

# Temperature
djf_rcm_tas_hist_samz, mam_rcm_tas_hist_samz, jja_rcm_tas_hist_samz, son_rcm_tas_hist_samz = import_rcm('tas', 'samz', 'hist', '1986-2005')
djf_gcm_tas_hist_samz, mam_gcm_tas_hist_samz, jja_gcm_tas_hist_samz, son_gcm_tas_hist_samz = import_gcm('tas', 'samz', 'hist', '1986-2005')
djf_rcm_tas_rcp26_samz, mam_rcm_tas_rcp26_samz, jja_rcm_tas_rcp26_samz, son_rcm_tas_rcp26_samz = import_rcm('tas', 'samz', 'rcp26', '2080-2099')
djf_gcm_tas_rcp26_samz, mam_gcm_tas_rcp26_samz, jja_gcm_tas_rcp26_samz, son_gcm_tas_rcp26_samz = import_gcm('tas', 'samz', 'rcp26', '2080-2099')
djf_rcm_tas_rcp85_samz, mam_rcm_tas_rcp85_samz, jja_rcm_tas_rcp85_samz, son_rcm_tas_rcp85_samz = import_rcm('tas', 'samz', 'rcp85', '2080-2099')
djf_gcm_tas_rcp85_samz, mam_gcm_tas_rcp85_samz, jja_gcm_tas_rcp85_samz, son_gcm_tas_rcp85_samz = import_gcm('tas', 'samz', 'rcp85', '2080-2099')

djf_rcm_tas_hist_eneb, mam_rcm_tas_hist_eneb, jja_rcm_tas_hist_eneb, son_rcm_tas_hist_eneb = import_rcm('tas', 'eneb', 'hist', '1986-2005')
djf_gcm_tas_hist_eneb, mam_gcm_tas_hist_eneb, jja_gcm_tas_hist_eneb, son_gcm_tas_hist_eneb = import_gcm('tas', 'eneb', 'hist', '1986-2005')
djf_rcm_tas_rcp26_eneb, mam_rcm_tas_rcp26_eneb, jja_rcm_tas_rcp26_eneb, son_rcm_tas_rcp26_eneb = import_rcm('tas', 'eneb', 'rcp26', '2080-2099')
djf_gcm_tas_rcp26_eneb, mam_gcm_tas_rcp26_eneb, jja_gcm_tas_rcp26_eneb, son_gcm_tas_rcp26_eneb = import_gcm('tas', 'eneb', 'rcp26', '2080-2099')
djf_rcm_tas_rcp85_eneb, mam_rcm_tas_rcp85_eneb, jja_rcm_tas_rcp85_eneb, son_rcm_tas_rcp85_eneb = import_rcm('tas', 'eneb', 'rcp85', '2080-2099')
djf_gcm_tas_rcp85_eneb, mam_gcm_tas_rcp85_eneb, jja_gcm_tas_rcp85_eneb, son_gcm_tas_rcp85_eneb = import_gcm('tas', 'eneb', 'rcp85', '2080-2099')

djf_rcm_tas_hist_matopiba, mam_rcm_tas_hist_matopiba, jja_rcm_tas_hist_matopiba, son_rcm_tas_hist_matopiba = import_rcm('tas', 'matopiba', 'hist', '1986-2005')
djf_gcm_tas_hist_matopiba, mam_gcm_tas_hist_matopiba, jja_gcm_tas_hist_matopiba, son_gcm_tas_hist_matopiba = import_gcm('tas', 'matopiba', 'hist', '1986-2005')
djf_rcm_tas_rcp26_matopiba, mam_rcm_tas_rcp26_matopiba, jja_rcm_tas_rcp26_matopiba, son_rcm_tas_rcp26_matopiba = import_rcm('tas', 'matopiba', 'rcp26', '2080-2099')
djf_gcm_tas_rcp26_matopiba, mam_gcm_tas_rcp26_matopiba, jja_gcm_tas_rcp26_matopiba, son_gcm_tas_rcp26_matopiba = import_gcm('tas', 'matopiba', 'rcp26', '2080-2099')
djf_rcm_tas_rcp85_matopiba, mam_rcm_tas_rcp85_matopiba, jja_rcm_tas_rcp85_matopiba, son_rcm_tas_rcp85_matopiba = import_rcm('tas', 'matopiba', 'rcp85', '2080-2099')
djf_gcm_tas_rcp85_matopiba, mam_gcm_tas_rcp85_matopiba, jja_gcm_tas_rcp85_matopiba, son_gcm_tas_rcp85_matopiba = import_gcm('tas', 'matopiba', 'rcp85', '2080-2099')
...
plt.xticks(time, ('DJF', 'MAM', 'JJA', 'SON'), fontsize=8)
...
plt.xticks(time, ('DJF', 'MAM', 'JJA', 'SON'), fontsize=8)
plt.yticks(np.arange(-1, 10, 1), fontsize=8)
plt.ylim(-1, 8)
plt.axhline(0, linewidth=1., linestyle='--', color='black')
plt.setp(ax.get_xticklabels(), visible=False)
plt.grid(True, which='major', linestyle='--')
