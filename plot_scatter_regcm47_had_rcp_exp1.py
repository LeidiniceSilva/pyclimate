...
__date__        = "12/29/2020"
__description__ = "This script plot scatter plot from regcm47 and hadgem models to rcp"
...
plt.ylabel(u'Temperature change (Â°C)', fontweight='bold')
...
plt.xlabel(u'Precipitation change (mm dâ»Â¹)', fontweight='bold')
...
name_out = 'pyplt_scatter_reg_had_rcp.png'
