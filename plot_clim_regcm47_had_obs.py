...
line1, = ax1_inset.plot(xcdf_pre_cru_samz, cdf_pre_cru_samz, color='black', label='CRU', linestyle='-', linewidth=1.)
line1, = ax1_inset.plot(xcdf_pre_reg_samz, cdf_pre_reg_samz, color='green', label='Reg', linestyle='-', linewidth=1.)
line1, = ax1_inset.plot(xcdf_pre_had_samz, cdf_pre_had_samz, color='magenta', label='Had', linestyle='-', linewidth=1.)
ax1_inset.set_ylabel(u'CDF', fontweight='bold', fontsize=7)
...
ax1_inset.xaxis.set_tick_params(labelsize=7)
ax1_inset.yaxis.set_tick_params(labelsize=7)

ax1_1 = ax1_inset.twinx()
line1_1, = ax1_1.plot(xpdf_pre_cru_samz, pdf_pre_cru_samz, color='black', linestyle='-', linewidth=1.)
line1_1, = ax1_1.plot(xpdf_pre_reg_samz, pdf_pre_reg_samz, color='green', linestyle='-', linewidth=1.)
line1_1, = ax1_1.plot(xpdf_pre_had_samz, pdf_pre_had_samz, color='magenta', linestyle='-', linewidth=1.)
ax1_1.set_ylabel(u'PDF', fontweight='bold', fontsize=7)
ax1_1.set_xlim(0, 15)
...
plt.legend(annual_cycle1, legend, fontsize=6, loc=1, shadow=True, ncol=1)

ax2_inset = inset_axes(ax20, width='30%', height='30%', loc='upper left', bbox_to_anchor=(0.175,0,1,1), bbox_transform=ax20.transAxes)
line2, = ax2_inset.plot(xcdf_tas_cru_samz, cdf_tas_cru_samz, color='black', linestyle='-', linewidth=1.)
line2, = ax2_inset.plot(xcdf_tas_reg_samz, cdf_tas_reg_samz, color='green', linestyle='-', linewidth=1.)
line2, = ax2_inset.plot(xcdf_tas_had_samz, cdf_tas_had_samz, color='magenta', linestyle='-', linewidth=1.)
ax2_inset.set_ylabel(u'CDF', fontweight='bold', fontsize=7)
...
ax2_inset.xaxis.set_tick_params(labelsize=7)
ax2_inset.yaxis.set_tick_params(labelsize=7)

ax2_1 = ax2_inset.twinx()
line2_1, = ax2_1.plot(xpdf_tas_cru_samz, pdf_tas_cru_samz, color='black', linestyle='-', linewidth=1.)
line2_1, = ax2_1.plot(xpdf_tas_reg_samz, pdf_tas_reg_samz, color='green', linestyle='-', linewidth=1.)
line2_1, = ax2_1.plot(xpdf_tas_had_samz, pdf_tas_had_samz, color='magenta', linestyle='-', linewidth=1.)
ax2_1.set_ylabel(u'PDF', fontweight='bold', fontsize=7)
...
line3, = ax3_inset.plot(xcdf_pre_cru_eneb, cdf_pre_cru_eneb, color='black', linestyle='-', linewidth=1.)
line3, = ax3_inset.plot(xcdf_pre_reg_eneb, cdf_pre_reg_eneb, color='green', linestyle='-', linewidth=1.)
line3, = ax3_inset.plot(xcdf_pre_had_eneb, cdf_pre_had_eneb, color='magenta', linestyle='-', linewidth=1.)
ax3_inset.set_ylabel(u'CDF', fontweight='bold', fontsize=7)
...
ax3_inset.xaxis.set_tick_params(labelsize=7)
ax3_inset.yaxis.set_tick_params(labelsize=7)

ax3_1 = ax3_inset.twinx()
line3_1, = ax3_1.plot(xpdf_pre_cru_eneb, pdf_pre_cru_eneb, color='black', linestyle='-', linewidth=1.)
line3_1, = ax3_1.plot(xpdf_pre_reg_eneb, pdf_pre_reg_eneb, color='green', linestyle='-', linewidth=1.)
line3_1, = ax3_1.plot(xpdf_pre_had_eneb, pdf_pre_had_eneb, color='magenta', linestyle='-', linewidth=1.)
ax3_1.set_ylabel(u'PDF', fontweight='bold', fontsize=7)
ax3_1.set_xlim(0, 15)
...
ax4_inset = inset_axes(ax40, width='30%', height='30%', loc='upper left', bbox_to_anchor=(0.175,0,1,1), bbox_transform=ax40.transAxes)
line4, = ax4_inset.plot(xcdf_tas_cru_eneb, cdf_tas_cru_eneb, color='black', linestyle='-', linewidth=1.)
line4, = ax4_inset.plot(xcdf_tas_reg_eneb, cdf_tas_reg_eneb, color='green', linestyle='-', linewidth=1.)
line4, = ax4_inset.plot(xcdf_tas_had_eneb, cdf_tas_had_eneb, color='magenta', linestyle='-', linewidth=1.)
ax4_inset.set_ylabel(u'CDF', fontweight='bold', fontsize=7)
ax4_inset.set_xlim(22, 37)
ax4_inset.set_ylim(0, 1)
ax4_inset.set_xticks(np.arange(22, 40, 3))
ax4_inset.set_yticks(np.arange(0, 1.1, 0.5))
ax4_inset.xaxis.set_tick_params(labelsize=7)
ax4_inset.yaxis.set_tick_params(labelsize=7)

ax4_1 = ax4_inset.twinx()
line4_1, = ax4_1.plot(xpdf_tas_cru_eneb, pdf_tas_cru_eneb, color='black', linestyle='-', linewidth=1.)
line4_1, = ax4_1.plot(xpdf_tas_reg_eneb, pdf_tas_reg_eneb, color='green', linestyle='-', linewidth=1.)
line4_1, = ax4_1.plot(xpdf_tas_had_eneb, pdf_tas_had_eneb, color='magenta', linestyle='-', linewidth=1.)
ax4_1.set_ylabel(u'PDF', fontweight='bold', fontsize=7)
...
line5, = ax5_inset.plot(xcdf_pre_cru_matopiba, cdf_pre_cru_matopiba, color='black', linestyle='-', linewidth=1.)
line5, = ax5_inset.plot(xcdf_pre_reg_matopiba, cdf_pre_reg_matopiba, color='green', linestyle='-', linewidth=1.)
line5, = ax5_inset.plot(xcdf_pre_had_matopiba, cdf_pre_had_matopiba, color='magenta', linestyle='-', linewidth=1.)
ax5_inset.set_ylabel(u'CDF', fontweight='bold', fontsize=7)
...
ax5_inset.xaxis.set_tick_params(labelsize=7)
ax5_inset.yaxis.set_tick_params(labelsize=7)

ax5_1 = ax5_inset.twinx()
line5_1, = ax5_1.plot(xpdf_pre_cru_matopiba, pdf_pre_cru_matopiba, color='black', linestyle='-', linewidth=1.)
line5_1, = ax5_1.plot(xpdf_pre_reg_matopiba, pdf_pre_reg_matopiba, color='green', linestyle='-', linewidth=1.)
line5_1, = ax5_1.plot(xpdf_pre_had_matopiba, pdf_pre_had_matopiba, color='magenta', linestyle='-', linewidth=1.)
ax5_1.set_ylabel(u'PDF', fontweight='bold', fontsize=7)
ax5_1.set_xlim(0, 15)
...
ax6_inset = inset_axes(ax60, width='30%', height='30%', loc='upper left', bbox_to_anchor=(0.175,0,1,1), bbox_transform=ax60.transAxes)
line6, = ax6_inset.plot(xcdf_tas_cru_matopiba, cdf_tas_cru_matopiba, color='black', linestyle='-', linewidth=1.)
line6, = ax6_inset.plot(xcdf_tas_reg_matopiba, cdf_tas_reg_matopiba, color='green', linestyle='-', linewidth=1.)
line6, = ax6_inset.plot(xcdf_tas_had_matopiba, cdf_tas_had_matopiba, color='magenta', linestyle='-', linewidth=1.)
ax6_inset.set_ylabel(u'CDF', fontweight='bold', fontsize=7)
...
ax6_inset.xaxis.set_tick_params(labelsize=7)
ax6_inset.yaxis.set_tick_params(labelsize=7)

ax6_1 = ax6_inset.twinx()
line6_1, = ax6_1.plot(xpdf_tas_cru_matopiba, pdf_tas_cru_matopiba, color='black', linestyle='-', linewidth=1.)
line6_1, = ax6_1.plot(xpdf_tas_reg_matopiba, pdf_tas_reg_matopiba, color='green', linestyle='-', linewidth=1.)
line6_1, = ax6_1.plot(xpdf_tas_had_matopiba, pdf_tas_had_matopiba, color='magenta', linestyle='-', linewidth=1.)
ax6_1.set_ylabel(u'PDF', fontweight='bold', fontsize=7)
