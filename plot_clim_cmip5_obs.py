...
colors = plt.matplotlib.cm.binary(np.linspace(0.1, 0.6, 30))
...
plt.setp(l1, color=colors[0])
plt.setp(l2, color=colors[1])
plt.setp(l3, color=colors[2])
plt.setp(l4, color=colors[3])
plt.setp(l5, color=colors[4])
plt.setp(l6, color=colors[5])
plt.setp(l7, color=colors[6])
plt.setp(l8, color=colors[7])
plt.setp(l9, color=colors[8])
plt.setp(l10, color=colors[9])
plt.setp(l11, color=colors[10])
plt.setp(l12, color=colors[11])
plt.setp(l13, color=colors[12])
plt.setp(l14, color=colors[13])
plt.setp(l15, color=colors[14])
plt.setp(l16, color=colors[15])
plt.setp(l17, color=colors[16])
plt.setp(l18, color=colors[17])
plt.setp(l19, color=colors[18])
plt.setp(l20, color=colors[19])
plt.setp(l21, color=colors[20])
plt.setp(l22, color=colors[21])
plt.setp(l23, color=colors[22])
plt.setp(l24, color=colors[23])
plt.setp(l25, color=colors[24])
plt.setp(l26, color=colors[25])
plt.setp(l27, color=colors[26])
plt.setp(l28, color=colors[27])
plt.setp(l29, color=colors[28])
plt.setp(l30, color=colors[29])
plt.setp(l31, color='black', linestyle='dashed')
